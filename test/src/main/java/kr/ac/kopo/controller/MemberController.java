...
public class MemberController {
	...
	@PostMapping("/signup")
	public String signup(@Valid User item,BindingResult result, HttpServletResponse response, RedirectAttributes ra, HttpSession session) throws Exception{
		if(result.hasErrors()){
...
*/
	...
	public String findpasswd(User user, RedirectAttributes ra, HttpSession session) throws Exception {
	...
	@PostMapping("/login")
	public String login(User item, RedirectAttributes ra, HttpSession session) throws Exception {
