    ...
    <h1>통합로그인</h1> 		
	  ...
	  <div class="pass"></div>
        ...
        <div class="signup_link">
          	<a href="/member/signup"class="btn btn-primary"  style="margin: 30px">회원가입</a> <a href="/member/findpasswd" class="btn btn-primary" style="margin: 30px">비밀번호찾기</a><a href="/" class="btn btn-warning"  style="margin: 30px">첫 화면으로 나가기</a>
        </div>
